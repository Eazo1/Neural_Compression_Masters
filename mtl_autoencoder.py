...
#KAPPA = 0.01  # Hyperparameter for the Wasserstein-2 term
...
while iteration < num_training_updates:
    ...
    for images in train_loader:
        ...
        loss = mse_loss + DELTA * chi2  # No .item() here!
        ...
        wandb.log({
                    ...
                    "train/loss_components.D*chi2": (DELTA * chi2.item())
                    })
        ...
        if iteration % 100 == 0:
            ...
            with torch.no_grad():
                for val_images in valid_loader:
                    ...
                    loss_val = mse_loss_val + DELTA * chi2_val
